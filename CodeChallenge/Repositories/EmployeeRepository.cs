...
namespace CodeChallenge.Repositories
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        /// <summary>
        /// Recursively maps direct report employees to given employee
        /// </summary>
        /// <param name="employee">
        /// Employee to map reporters to
        /// </param>
        private void LoadDirectReports(Employee employee)
        {
            ...
            foreach (var reportEmployee in employee.DirectReports)
            {
                LoadDirectReports(reportEmployee);
            }
        }
    }
}
